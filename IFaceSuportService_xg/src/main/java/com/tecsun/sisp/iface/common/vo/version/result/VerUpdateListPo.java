...
/**
 * Created by zhuxiaokai on 15-12-25.
 */
public class VerUpdateListPo {
    private Long id;//主键ID
    private String deviceNo;//设备ID
    private Long versionId;//软件版本表ID
    private String status;//更新状态
    private Date updateTime;//更新时间
    private Date finishTime;//完成时间
    private String returnCode;//终端更新返回码
    private String updateType;//更新类型
    private Date createTime;//添加时间
    private String createUser;//添加人
    private Date modTime;//修改时间
    private String modUser;//修改人
    private Integer pushNum;//版本推送次数
