...
public class PreparePaginationInterceptor extends com.tecsun.sisp.iface.server.util.page.BaseInterceptor {
...
//            if (StringUtils.indexOfIgnoreCase(mappedStatement.getId(), _SQL_PATTERN) != -1) {
                ...
                if (parameterObject == null) {
                    ...
                    //记录统计
                    final int count = com.tecsun.sisp.iface.server.util.page.SQLHelper.getCount(sql, connection, mappedStatement, parameterObject, boundSql, log);
                    Page<Object> page = null;
                    page = convertParameter(parameterObject, page);
                    page.setCount(count);
                    String pagingSql = com.tecsun.sisp.iface.server.util.page.SQLHelper.generatePageSql(sql, page, DIALECT);
