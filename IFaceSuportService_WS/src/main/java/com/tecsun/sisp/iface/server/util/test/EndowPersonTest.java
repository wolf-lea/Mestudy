...
public class EndowPersonTest {
    ...
    public static void main(String[] args)throws Exception{
        ...
        json2.put("aac002","410225195707291567");

        JSONObject json3 = new JSONObject();
        json3.put("aac002","410225195109152946");
        ...
        //城乡养老
        String getEndowInfoPerson = (String)getWebClient(url + "/iface/so/getEndowInfoPerson" + "?devId=" + devId + "&token=" + token,json2,String.class);
        System.out.println("1》》》"+getEndowInfoPerson);

        String getEndowPayPerson = (String)getWebClient(url + "/iface/so/getEndowPayPerson" + "?devId=" + devId + "&token=" + token,json2,String.class);
        System.out.println("2》》》"+getEndowPayPerson);

        String getEndowAccountPerson = (String)getWebClient(url + "/iface/so/getEndowAccountPerson" + "?devId=" + devId + "&token=" + token,json2,String.class);
        System.out.println("3》》》"+getEndowAccountPerson);

        String getEndowAnnuityPerson = (String)getWebClient(url + "/iface/so/getEndowAnnuityPerson" + "?devId=" + devId + "&token=" + token,json3,String.class);
        System.out.println("4》》》"+getEndowAnnuityPerson);
