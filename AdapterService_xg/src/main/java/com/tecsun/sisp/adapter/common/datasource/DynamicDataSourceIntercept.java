...
public class DynamicDataSourceIntercept {
	...
	public void before(JoinPoint joinPoint) {
		...
		if (methodName.toLowerCase().contains("4sisp")) {
			CustomerContextHolder.setCustomerType(CustomerContextHolder.SISP_DATASOURCE);
			...
			CustomerContextHolder.setCustomerType(CustomerContextHolder.SSSM_DATASOURCE);
	...
	public void afterThrowing(JoinPoint joinPoint, Exception e) {
		logger.error("异常类=======:" + joinPoint.getTarget().getClass() + "==" + e.getMessage(), e);
	}
}
