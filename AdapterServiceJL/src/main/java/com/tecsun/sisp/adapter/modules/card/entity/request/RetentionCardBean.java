 ...
 */
public class RetentionCardBean extends SecQueryBean{
    private Long id;
    ...
    public String getRetenTime() {
        return retenTime;
    }

    public void setRetenTime(String retenTime) {
