...
public class QRCodeFactory {
     ...
     */
    public  String CreatQrImage(String content,String format,String outFileUri,String logoUri, int ...size) throws IOException, WriterException {
        ...
        String qrBase64 = MatrixToImageWriter.writeToFile(bitMatrix, format, outputFile,logoUri);
