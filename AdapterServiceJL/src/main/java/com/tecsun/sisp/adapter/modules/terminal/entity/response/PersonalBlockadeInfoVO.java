 ...
 *	个人封锁信息 
 */
public class PersonalBlockadeInfoVO {
	 ...
	 private String medicalInsuranceCardNo;	// 医保卡号
	...
	/**
	 * @param blockadeReason the blockadeReason to set
	 */
	...
	/**
	 * @param blockadeFlag the blockadeFlag to set
	 */
	...
	/**
	 * @return the medicalInsuranceCardNo
	 */
	...
	/**
	 * @param medicalInsuranceCardNo the medicalInsuranceCardNo to set
	 */
	...
	/**
	 * @param coordinationArea the coordinationArea to set
	 */
