...
public class AccountBean extends SecQueryBean {
    ...
    private String pic;//个人信息头像
    
    private String isWechat;//微信人脸比对是否通过，1=通过，0=不通过
    private String comparePicId;//微信比对照片
    private String isSuccessBind;//绑定/解绑标志：绑定：1，解绑：0
	...
	public String getComparePicId() {
		return comparePicId;
	}

	public void setComparePicId(String comparePicId) {
		this.comparePicId = comparePicId;
	}
