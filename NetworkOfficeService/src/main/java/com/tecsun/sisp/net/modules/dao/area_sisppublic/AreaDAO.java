package com.tecsun.sisp.net.modules.dao.area_sisppublic;
...
public interface AreaDAO {
	...
	public List<UserRolVo> queryUserRloe(UserRoleBean vo);//角色查询
	...
	public List<MatterRoleBean>queryByMatterAndRole();
