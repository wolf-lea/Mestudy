...
public class Constants {
    ...
    //预制卡盒状态
    public static final String REPLACECARD_BOX_STATUS_00="00";//未下发
    public static final String REPLACECARD_BOX_STATUS_01="01";//已接收
    public static final String REPLACECARD_BOX_STATUS_02="02";//已下发
    public static final String REPLACECARD_BOX_STATUS_03="03";//已下发
    
    public static Map<String,String> REPLACECARD_BOX_STATUS=new HashMap<>();
    static{
    	REPLACECARD_BOX_STATUS.put("00","未下发");
    	REPLACECARD_BOX_STATUS.put("01","已接收");
    	REPLACECARD_BOX_STATUS.put("02","部分下发");
    	REPLACECARD_BOX_STATUS.put("03","全部下发");
    }
}
