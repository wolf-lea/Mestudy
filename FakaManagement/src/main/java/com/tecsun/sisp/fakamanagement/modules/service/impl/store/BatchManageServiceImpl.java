...
public class BatchManageServiceImpl extends BaseService{
    ...
    public List<BatchManageVO> getBatchInfos(BatchManageBean bean){
       return this.getFakaSqlSessionTemplate().selectList("getBatchInfos",bean);
    }

    public int addBatchInfo(BatchManageVO vo){
        return this.getFakaSqlSessionTemplate().insert("addBatchInfo",vo);
    }

    public List<BatchManageVO> getBatchInfoDetail(BatchManageBean bean){
        return this.getFakaSqlSessionTemplate().selectList("getBatchInfoDetail",bean);
    }

    public int updateBatchStatus(BatchManageVO vo){
        return this.getFakaSqlSessionTemplate().update("updateBatchStatus",vo);
    }

    public int addBatchBinBox(BatchManageVO vo){
        return this.getFakaSqlSessionTemplate().insert("addBatchBinBox",vo);
    }

    public int addBatchDetail(BatchManageVO vo){
        return this.getFakaSqlSessionTemplate().insert("addBatchDetail",vo);
    }

    //查询箱盒信息
    public List<BatchManageVO> getBatchidBinBoxInfo(BatchManageVO vo){
        return this.getFakaSqlSessionTemplate().selectList("getBatchidBinBoxInfo",vo);
    }

    //根据身份证号查询卡信息
    public List<BatchManageVO> getCardDetailByIdcard(BatchManageVO vo){
        return this.getFakaSqlSessionTemplate().selectList("getCardDetailByIdcard",vo);
    }
    public List<BatchManageVO> getCardInfoByIdcard(BatchManageVO vo){
        return this.getFakaSqlSessionTemplate().selectList("getCardInfoByIdcard",vo);
    }

    //二次入库-新增卡详细信息
    public int addCardInfoDetail(BatchManageVO vo){
        return this.getFakaSqlSessionTemplate().insert("addCardInfoDetail",vo);
    }
    //二次入库-新增卡位置信息
    public int addCardStoreDetail(BatchManageVO vo){
        return this.getFakaSqlSessionTemplate().insert("addCardStoreDetail",vo);
    }
        ...
        try{
            ...
            for(BatchManageVO vo : list){
                ...
                if(batchList!=null && batchList.size()>0){
                    vo.setBatchId(batchList.get(0).getBatchId());
