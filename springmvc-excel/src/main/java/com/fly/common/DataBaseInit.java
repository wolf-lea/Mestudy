...
public class DataBaseInit
{
     ...
     * @see [类、类#方法、类#成员]
     */
    public static void initUseSQL2(String... sqlPathArr)
        throws IOException, SQLException
    {
        // 建库用临时DataSource
        MysqlDataSource dataSource = new MysqlDataSource();
        ...
        // 按需建库
        queryRunner.execute(String.format("CREATE DATABASE IF NOT EXISTS `%s` DEFAULT CHARACTER SET UTF8", dataBase));
