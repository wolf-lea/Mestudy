...
public class DictionaryUtil {
    ...
    public static String getHost(String uri) {
        com.tecsun.sisp.iface.common.util.Config config = com.tecsun.sisp.iface.common.util.Config.getInstance();
     ...
     * @throws Exception
     */
    public static String getDictName(String groupId,String code){
        try {
