...
import com.tecsun.sisp.iface.common.vo.common.param.DevBean;
        ...
        try {
            ...
            if (StringUtils.isBlank(redisIP)) {
                ...
                if (!redisIP.equals(ip)) {
                	...
                	if(StringUtils.isBlank(deviceid)){//第三方公司拦截
                		//1.先验证url地址
                		String method = req.getParameter("method");
                		if(StringUtils.isBlank(method)){
                			logger.error("IFACE_ERRORCODE:IFAC-EERR-301,拦截非法访问,第三方接口方法为空");
                			resp.getWriter().print(GlobalResult.error_301("拦截非法访问，接口方法为空"));
                		}else{
